    ...
    fields: [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: "author_description", title: "Author Description", type: "string" },
          { name: "author_image_url", title: "Author Image URL", type: "url" }, // Already using URL here
        ],
      },
      {
        name: "read_time",
      ...
      {
        name: "imageUrl", // Change this to a URL instead of an image type
